...
from .managers import ProductManager, OrderQuerySet
...
class Product(models.Model):
    ...
    def get_absolute_url(self):
        return reverse(
            ...
            kwargs={"brand_and_name": f"{self.brand.slug}_{self.slug}"},
        )
...
class Favorite(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("store:favorite-detail", kwargs={"pk": self.pk})
